...
public class Arrays {
  ...
  /**
   * @Overview : Determine whether an array of integers is in ascending order, a not null
   * 
   * @requires
   *  a != null 
   * @effects
  ...
  /**
   * @Overview : Return the length of a array of CHARS (array not null) on the understanding that if
  ...
  /**
   * @Overview : Return the median of an array of reals, that is the array value closest
   * to the middle in the sense that as many array elements are smaller than it
   * as are greater than it. array not null and all elements are distinct.
   * 
   * @requries 
 ...
 /** 
  * @Overview : Given two arbitrary arrays of reals, a and b, determine if a sub-set b, a super-set b, a intersects with b, or a = b. a and b not null
  * 
  * @requires
  *   a != null /\ b != null
  * @effects
  ...
  */ 
  ...
  /**
   * 
   * @Overview : Compute the frequencies of each element of an array of reals. array not null
   * 
   * @requires 
   *    a != null
   * @effects 
